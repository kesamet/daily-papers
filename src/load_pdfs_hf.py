"""
Script loads the daily papers from Hugging Face's papers page, downloads their PDFs,
...
def load_pdfs_hf() -> None:
    ...
    for paper_div in soup.find_all("div", class_="w-full"):
        ...
        if title_tag:
            ...
            logger.warning("Title not found for a paper")
            continue
    ...
    data_file_path = os.path.join(DATA_DIR, f"{ddate}_papers.json")
